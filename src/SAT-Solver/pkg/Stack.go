...
func (s *Stack) Push(value int, isBranch, triedBothWays bool) {
	s.elements = append(s.elements, VariableAssignment{Literal: value, IsBranch: isBranch, TriedBothWays: triedBothWays})
}
